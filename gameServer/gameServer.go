...
func (server *GameServer) setIPAddress(ipAddr string) bool {
...
func (server *GameServer) OnConnect(sessionIndex int32, sessionUniqueID uint64){
...
func (server *GameServer) OnReceive( sessionIndex int32, sessionUniqueID uint64, data[] byte ) bool {
