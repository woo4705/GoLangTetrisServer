...
const (
	...
	PACKET_ID_GAME_READY_REQ = 751

	PACKET_ID_USER_STATUS_NTF = 752
	PACKET_ID_GAME_START_NTF = 762

	PACKET_ID_GAME_SYNC_REQ = 304
	PACKET_ID_GAME_SYNC_NTF = 305

	PACKET_ID_GAME_END_REQ = 311
	PACKET_ID_GAME_END_RES = 312
	PACKET_ID_GAME_END_NTF = 313
